...
| Actors | `<actor>` | •Fully replaces all existing Actors<br>•Disambiguated `(N)` actors are kept<br>•Sticky Actors come first<br>•Actors without Thumbs come last<br>•Eliminate Male Actors | Always replaced w/ IAFD Actors |
