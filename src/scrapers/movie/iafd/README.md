...
| Actors | `<actor>` | •Fully replaces all existing Actors<br>•Disambiguated `(N)` actors are kept<br>•Sticky Actors come first<br>•Actors with Thumbnails come next (then Alpha)<br>•Actors without Thumbs come last (then Alpha)<br>•Eliminate Male Actors | Always replaced w/ IAFD Actors |
