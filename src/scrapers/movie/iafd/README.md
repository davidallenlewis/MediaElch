...
| Actors | `<actor>` | •Fully replaces all existing Actors<br>•Sorted A-Z in 3 groups (Sticky, w/ Thumb, w/o Thumb)<br>•Disambiguated `(N)` actors are kept<br>•Male Actors are removed | Always replaced w/ IAFD Actors |
