...
| Actors | `<actor>` | •Fully replaces all existing Actors<br>•Disambiguated `(N)` actors are kept<br>•Sort by sticky then w/ and w/o thumbnail<br>•Eliminate Male Actors | Always replaced with IAFD Actors |
