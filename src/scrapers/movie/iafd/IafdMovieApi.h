...
///          Movie search is performed via DuckDuckGo's HTML endpoint and
...
public:
    ...
    /// \brief Search IAFD for movie pages matching \p query.
    ...
    static QUrl makeMovieSearchUrl(const QString& searchStr);
